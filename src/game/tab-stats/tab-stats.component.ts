...
let heroStatNames = {
	...
	'sombra': ['weapon accuracy', 'enemies hacked', 'kill streak - best', 'enemied emp\'d', 'offensive assists'],
	...
	'roadhog': ['weapon accuracy', 'hook accuracy', 'kill streak - best', 'self healing', 'enemied hooked', 'whole hog kills'],
...
export class TabStatisticsComponent {
    ...
    ngOnInit(): void {
        ...
        for (let i in this.tabStatistics.hero){
            ...
            if (this.tablePanes.indexOf(hero) == -1 && showHero){
                this.tablePanes.push(hero);
            }
        }
        // console.log(this.tablePanes);
